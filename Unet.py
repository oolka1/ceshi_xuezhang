...
from layers import unetConv2,unetUp,unetConv2_dilation
...
class UNet_Nested_dilated(nn.Module):
    ...
    def __init__(self, in_channels=1, n_classes=4, feature_scale=8, is_deconv=True, is_batchnorm=True,is_ds=True):
