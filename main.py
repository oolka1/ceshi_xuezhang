...
traindataloader = torch.utils.data.DataLoader(train_dataset, batch_size=8*(config.batchsize), shuffle=True, 
                                              num_workers=4)
...
optimizer = optim.Adam(classifier.parameters(), lr=config.lr,weight_decay = 5e-5)
